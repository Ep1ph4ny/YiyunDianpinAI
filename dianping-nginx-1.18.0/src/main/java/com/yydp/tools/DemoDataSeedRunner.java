...
import com.yydp.YyDianPingApplication;
...
public class DemoDataSeedRunner {
    ...
    public static void main(String[] args) {
        ...
        setSystemPropertyIfAbsent("logging.level.com.yydp", "info");
        ...
        defaults.put("logging.level.com.yydp", "info");
        defaults.put("mybatis-plus.configuration.log-impl", "org.apache.ibatis.logging.nologging.NoLoggingImpl");

        ConfigurableApplicationContext ctx = new SpringApplicationBuilder(YyDianPingApplication.class)
