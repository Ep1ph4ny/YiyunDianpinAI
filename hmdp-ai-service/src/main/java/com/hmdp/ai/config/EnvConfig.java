...
public class EnvConfig implements EnvironmentPostProcessor, Ordered {
    ...
    private static final String PROPERTY_SOURCE_NAME = "hmdpAiDotenv";
    ...
    private Path findEnvDirectory() {
        String configuredDir = firstNotBlank(System.getProperty("hmdp.ai.env-dir"), System.getenv("HMDP_AI_ENV_DIR"));
        ...
        Path fromRootUserDir = resolveIfContainsEnv(pathOf(userDir, "hmdp-ai-service"));
